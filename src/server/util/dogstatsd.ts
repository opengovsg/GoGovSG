...
export const DIRECTORY_SEARCH_DOMAIN = 'directory.search.domain'
export const DIRECTORY_SEARCH_UNIQUE_DOMAINS = 'directory.search.unique_domains'
export const DIRECTORY_SEARCH_EMAIL = 'directory.search.email'
