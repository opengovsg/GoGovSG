...
import BaseLayoutHeader from './BaseLayoutHeader.js'
import BaseLayoutFooter from './BaseLayoutFooter.js'
import BaseLayoutLowFooter from './BaseLayoutLowFooter.js'
import checkIsIE from './util/ie.js'
import BannerForIE from './BannerForIE.js'
import { USER_PAGE } from '../../util/types.js'
