...
const LandingGraphicSliver = () => {
  ...
  const useTopPaddingMultipler = () => {
    ...
    const isMediumWidth = useMediaQuery(theme.breakpoints.up('md')) // eslint-disable-line react-hooks/rules-of-hooks
    const isDesktopWidth = useMediaQuery(theme.breakpoints.up('lg')) // eslint-disable-line react-hooks/rules-of-hooks
    if (isMediumWidth) {
      return 1
    }
    if (isDesktopWidth) {
