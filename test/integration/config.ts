...
export const SMALL_TEXT_FILE_PATH = './test/integration/assets/small-file.txt'
export const LARGE_TEXT_FILE_PATH = './test/integration/assets/large-file.txt'
...
export const ADMIN_API_V1_URLS = 'http://localhost:8080/admin/api/v1/urls'
